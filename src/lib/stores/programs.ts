import type { AppWindow } from './windows.svelte';
...
export const programs: ProgramDef[] = [
	{ id: 'home',             iconKey: 'about',        titleKey: 'nav.about',             defaultTitle: 'About',                startVisible: false, inStartMenu: false, maximizable: false, closable: true },
	...
	{ id: 'control-panel',    iconKey: 'controlPanel', titleKey: 'nav.controlPanel',      defaultTitle: 'Control Panel',        startVisible: false, inStartMenu: true,  maximizable: false, closable: true },
	{ id: 'personalization',  iconKey: 'wallpaper',    titleKey: 'nav.personalization',   defaultTitle: 'Personalization',      startVisible: false, inStartMenu: false, maximizable: false, closable: true },
...
/** Build the initial AppWindow array from program definitions */
export function buildWindows(): AppWindow[] {
